        ...
        32: [function(require, module, exports) {
            (function(Buffer) {
                ...
                exports.importPublic = function(e) {
                    ...
                    var r = exports.toBuffer("Ethereum Signed Message:\n" + e.length.toString());
                    return exports.sha3(Buffer.concat([r, e]))
                }, exports.ecrecover = function(e, r, t, f) {
                    var o = Buffer.concat([exports.setLength(t, 32), exports.setLength(f, 32)], 64),
                        s = r - 27;
                    ...
                    return exports.bufferToHex(Buffer.concat([exports.setLengthLeft(r, 32), exports.setLengthLeft(t, 32), exports.toBuffer(e - 27)]))
                }, exports.fromRpcSig = function(e) {
                    if (65 !== (e = exports.toBuffer(e)).length) throw new Error("Invalid signature length");
                    var r = e[64];
                    return r < 27 && (r += 27), {
                        v: r,
                        r: e.slice(0, 32),
                    ...
                    return e = exports.toBuffer(e), r = new BN(r), r = r.isZero() ? null : Buffer.from(r.toArray()), exports.rlphash([e, r]).slice(-20)
                    ...
                    var o = new BN("7fffffffffffffffffffffffffffffff5d576e7357a4501ddfe92f46681b20a0", 16),
                        s = new BN("fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141", 16);
                    return 32 === r.length && 32 === t.length && ((27 === e || 28 === e) && (r = new BN(r), t = new BN(t), !(r.isZero() || r.gt(s) || t.isZero() || t.gt(s)) && (!1 !== f || 1 !== new BN(t).cmp(o))))
                    ...
                    if (e.raw = [], e._fields = [], e.toJSON = function(r) {
                        ...
                        if ("string" == typeof t && (t = Buffer.from(exports.stripHexPrefix(t), "hex")), Buffer.isBuffer(t) && (t = rlp.decode(t)), Array.isArray(t)) {
                            ...
                            if ("object" !== (void 0 === t ? "undefined" : _typeof(t))) throw new Error("invalid data");
                            var f = Object.keys(t);
