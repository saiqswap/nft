...
window.Typekit.config = {
    "a": "106602318",
    "c": [".tk-roc-grotesk", "\"roc-grotesk\",sans-serif", ".tk-roc-grotesk-wide", "\"roc-grotesk-wide\",sans-serif"],
    "fi": [41111, 41113, 41115],
    "fc": [{
        "id": 41111,
        "family": "roc-grotesk",
        "src": "https://use.typekit.net/af/97dd77/00000000000000007735b7d4/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "stretch": "normal",
        ...
        "src": "https://use.typekit.net/af/bcc24a/00000000000000007735b7c2/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 41115,
        "family": "roc-grotesk-wide",
        "src": "https://use.typekit.net/af/ece23c/00000000000000007735b7ca/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "600",
            "style": "normal",
            "stretch": "normal",
    ...
    "fn": ["roc-grotesk", ["n4"], "roc-grotesk-wide", ["n4", "n6"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.21.0",
    "kt": "yhh7rwc",
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2022-06-05 15:21:02 UTC"}*/
;
(function(window, document, undefined) {
    ...
    fa.prototype.has = function(a) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.i; c++) {
            var d;
            if (b) d = q(a & 4294967295, 3432918353), d = d << 15 | d >>> 17, d = q(d, 461845907), d ^= ga[c] || 0, d = d << 13 | d >>> 19, d = q(d, 5) + 3864292196, d ^= 4, d ^= d >>> 16, d = q(d, 2246822507), d ^= d >>> 13, d = q(d, 3266489909), d ^= d >>> 16, d = (d >>> 0) % this.b;
            else {
                d = ga[c] || 0;
    ...
    m.ping && (W.m = new Ga);
    if (m.fc)
        for (var X = m.fc, Z = 0; Z < X.length; Z++) W.o.b.push(new ma(X[Z].family, X[Z].src, X[Z].descriptors));
    if (m.dl) {
        var La = m.dl;
        try {
            W.j = new ha(La)
    ...
    m.token && (W.i = m.token);
    if (m.c)
        for (var p = 0; p < m.c.length; p += 2) W.g.push(new da);
